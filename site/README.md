...
- The rendered page and social preview use the neutral synthetic Capture screen. Older Edit, Review, demo, and caption assets remain in the verified provenance inventory but are not presented as current product UI; refresh them before any publication that intends to surface them.
