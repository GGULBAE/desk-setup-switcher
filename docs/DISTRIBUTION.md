...
The version 0.1.0 no-Developer-ID packaging path passes locally. The current installed-layout/apply follow-up passed `make verify` on 2026-07-16 with 370 default cases (134 XCTest + 236 Swift Testing), universal Debug/Release, Analyze, DMG creation, SHA-256 validation, and mounted-image inspection. The current app contains `arm64` and `x86_64`; DMG SHA-256 is `e2927513543903b794bea08628064b29c12604e18706bef169c20b3e89760bcd`. This package replaced `/Applications/Desk Setup Switcher.app`; bundle identity, version, architectures, and signature passed read-only checks, and the app was not launched afterward.
