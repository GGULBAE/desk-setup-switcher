...
The current 2026-07-20 local release-controls candidate's no-Developer-ID path passed 3,046 deterministic checks/assertions: 506 app checks (183 XCTest cases, 322 default Swift Testing cases across 39 suites, and one isolated native `NSPopover` case in a 40th Swift Testing suite) plus 2,540 release-tooling assertions (328 base release-policy, 659 remote-controls v1 policy/normalizer, 178 remote-controls v2 lifecycle-policy, 69 remote-controls v2 collector, 234 publication-approval policy, 129 collector-wrapper mock, 71 draft-reconciler mock, 246 artifact-restoration mock, 424 approved-publication mock, and 202 shell/workflow guard assertions). Universal Debug/Release, Analyze, project-generation verification, DMG creation, SHA-256 validation, mounted metadata/resources, `arm64 x86_64`, and ad-hoc signature classification passed. The release-tooling evidence is simulated and structural, not a credentialed signing, notarization, protected-remote, or publication result. The package was not installed or launched.

- Current development-only DMG SHA-256: `6bd85f129d4b34f1fb5bd5da42336f23459221a932412fdf704ab227f5805ffb`
