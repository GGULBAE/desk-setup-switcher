...
- Before protected inventory/tester handoff, provide validator-tested sanitized full JSON examples or a policy-owned rejected-placeholder template generator for inventory, lineage, report, and set records; operators must not have to reverse-engineer test fixtures.
