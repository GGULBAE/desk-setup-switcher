...
- Pass integrated non-live `make verify` on 2026-07-20 with 3,046 deterministic checks/assertions: 506 app checks (183 XCTest, 322 default Swift Testing cases across 39 suites, and one isolated native popover case in a 40th Swift Testing suite) plus 2,540 release-tooling assertions (328 base release-policy, 659 remote-controls v1 policy/normalizer, 178 remote-controls v2 lifecycle-policy, 69 remote-controls v2 collector, 234 publication-approval policy, 129 collector-wrapper mock, 71 draft-reconciler mock, 246 artifact-restoration mock, 424 approved-publication mock, and 202 shell/workflow guard assertions). The latest regenerated unsigned development-evidence DMG SHA-256 is `6bd85f129d4b34f1fb5bd5da42336f23459221a932412fdf704ab227f5805ffb`; the DMG is not byte-for-byte reproducible, and the release assertions do not prove a real credentialed signing/notarization, protected-remote, or publication run.
