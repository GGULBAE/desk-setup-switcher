...
- Each menu profile now has a directly visible, named Delete control with inline confirmation that remains inside the MenuBarExtra, including Cancel/`Esc` and dirty-draft discard handling
- Partial captures now disclose sanitized item names and distinct snapshot-only, unreadable, permission-required, and unsupported explanations without captured values or runtime device identifiers
...
Evidence: the [manual UI audit](MANUAL-UI-AUDIT-2026-07-14.md) records 12 current-source PNGs and 12 nonempty read-only AX logs. Static English/Korean standard, 680×480 minimum, simulated `.accessibility3`, validation, System, and advanced-diagnostics states passed visual, AX-structure, and privacy review. The overview evidence covers profile deletion controls and the itemized partial-capture explanation; the editor evidence covers the wider card layout and expanded Audio/default-device rows. `UIAuditSafetyTests` proves the public audit actions do not invoke injected system/storage/login/permission dependencies. Final non-live `make verify` passed 298 default cases (129 XCTest plus 169 Swift Testing cases, six opt-in skips), zero failures, all Swift/Xcode Debug/Release and universal build gates, Analyze, and package verification. The replacement DMG SHA-256 is `273155843df1260ffb7555fe447d895e95696c95c28247fb023ad8f8ee2d39eb`; the preceding 297-case layout-correction SHA-256 `ae940ce1cffb969f309b8ffa8f6ffcd0637fd0845ee21bf24fa59129ea530ef7` remains historical.
...
- The tray/editor follow-up `make verify` produced and mounted the current `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg`, verified `x86_64 arm64`, resources, checksum, and ad-hoc/no-Developer-ID signature status; SHA-256 is `273155843df1260ffb7555fe447d895e95696c95c28247fb023ad8f8ee2d39eb`. The preceding layout-correction SHA-256 `ae940ce1cffb969f309b8ffa8f6ffcd0637fd0845ee21bf24fa59129ea530ef7` is historical
