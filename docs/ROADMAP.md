...
- The tray/responsive-settings follow-up `make verify` produced and mounted the current universal package with SHA-256 `8422b042b793bf0845ac56e2dcbd9808075a0467226d79ee65408440736648d8`; its executable matches the installed app byte-for-byte. The stable permission-handoff and earlier checksums above are historical.
