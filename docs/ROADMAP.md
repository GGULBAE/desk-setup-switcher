...
- Pass integrated non-live `make verify` on 2026-07-18 with 908 deterministic checks/assertions: 501 app checks (178 XCTest, 322 default Swift Testing cases across 39 suites, and one isolated native popover case in a 40th Swift Testing suite) plus 407 release-tooling assertions (328 Ruby policy and 79 shell guard assertions). The unsigned development-evidence DMG SHA-256 is `c1b406b4a29571ed721c0c0255c9d2220bdefb601a8c6639e0f136c41820c503`; the release assertions do not prove a real credentialed signing/notarization run.
