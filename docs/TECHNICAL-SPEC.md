...
The tray/settings refinement passes 339 default non-live cases (132 XCTest and 207 Swift Testing, with six explicit opt-in skips), lint/localization policy, Swift Debug/Release, universal Xcode Debug/Release, Xcode Analyze, package/checksum creation, and mounted DMG metadata/resource/architecture/signature verification. The current no-Developer-ID DMG SHA-256 is `567917f169e90799db177d0a5f22a8b13115cb30ed63f7e766fc4bb992ab35e3`. No live flag was set; the package was not installed or launched.
