...
The tray/settings end-to-end contract passes 366 default non-live cases (134 XCTest and 232 Swift Testing, with five explicit opt-in skips), lint/localization policy, Swift Debug/Release, universal Xcode Debug/Release, Xcode Analyze, package/checksum creation, and mounted DMG metadata/resource/architecture/signature verification. The current no-Developer-ID DMG SHA-256 is `76bc6d9f1187ea30f68be16ee81ee4a334d877a4e26c2497f35a9ffc781678b3`. No live flag was set; the package was not installed or launched.
