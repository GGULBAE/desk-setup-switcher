...
2. Open and verify the owner-controlled parent directory once, then create, permission to `0600`, write, and synchronize a uniquely named sibling staging file relative to that directory descriptor.
