...
“Unit verified,” “mock verified,” and “live-read verified” must never be shortened to “hardware verified.” As of 2026-07-14, **no live setting mutation is hardware verified**. The final-source UI-audit tree and deterministic tests described below passed the full non-live local gate; its package is build/mount verified, not installed or hardware-mutation verified.

## Platform

| Area | Target | Current evidence |
| --- | --- | --- |
| macOS | 14 Sonoma or later | Deployment target is 14.0. The UI-audit tree passed full local `make verify` on 2026-07-14 with 297 default cases (129 XCTest plus 168 Swift Testing cases, six opt-in skips), zero failures, and no live flag. The 290-case apply-reliability, 215-test header/editor, and 158-test 2026-07-11 gates remain historical evidence |
...
| Distribution | Direct no-Developer-ID DMG | Current `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg`, SHA-256 `ae940ce1cffb969f309b8ffa8f6ffcd0637fd0845ee21bf24fa59129ea530ef7`, passed checksum, mount, metadata/resources, `x86_64 arm64`, and ad-hoc/no-Developer-ID signature verification. The pre-layout-fix UI-audit SHA-256 `fa42df665ca453165dd041fe5112a8f1a6d2314bd31512ef9371b12289132122`, apply-reliability SHA-256 `417ffbb20b6a77b9037f42d5acb998574460374675e746715474e17f9f772615`, preceding header/editor SHA-256 `45772d20e6d7655c41ed4ff5d0261257b98f1361f4cf8cc38ebf837720d5820b`, and downloaded CI artifact ID `8256718472`, SHA-256 `f3d82b033e8e375c9063a9b72cbd174d94a03f0cdd4414961895db3b3dcfc3f4`, remain historical; nothing is published and the Gatekeeper path remains pending |
...
| --- | --- | --- |
| App | Background/menu-bar-only lifecycle | The 2026-07-11 fresh-DMG install launched from `/Applications` as background-only/menu-bar-only; popover rendering is historical evidence and `LSUIElement` remains verified in the current bundle. The current actual MenuBarExtra click/reopen path is pending |
...
| App | About and diagnostics presentation | Source/build verified for repository, issue, MIT license, and privacy links plus text-and-symbol diagnostic severity. Current English/Korean diagnostics screenshots and read-only AX logs passed static review; link activation and clear actions were not invoked |
...
| Diagnostics | Browse/refresh/clear in Settings | Implemented with sanitized events under Application Support. English/Korean disabled synthetic presentation passed screenshot/AX review; refresh/clear and real persisted-event flows remain pending |
