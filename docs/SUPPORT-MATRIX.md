...
| Distribution | Direct no-Developer-ID DMG | Current `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg`, SHA-256 `516b968718aeb3c1c247e1a2deca7a28d45820d119f31ea992d4b475071f3638`, passed checksum, mount, metadata/resources, `x86_64 arm64`, and ad-hoc/no-Developer-ID signature verification. It replaced the `/Applications` bundle and was not launched afterward. Earlier checksums remain historical; nothing is published and the Gatekeeper path remains pending |
...
The UI-stability non-live gate passes 375 default cases (134 XCTest with five skips plus 241 Swift Testing with two disabled opt-in cases), Swift/Xcode Debug and Release, Analyze, and universal mounted-package verification. Current local DMG SHA-256 is `516b968718aeb3c1c247e1a2deca7a28d45820d119f31ea992d4b475071f3638`; it replaced the `/Applications` bundle and was not launched afterward.
