...
| Distribution | Direct no-Developer-ID DMG | Current `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg`, SHA-256 `e2927513543903b794bea08628064b29c12604e18706bef169c20b3e89760bcd`, passed checksum, mount, metadata/resources, `x86_64 arm64`, and ad-hoc/no-Developer-ID signature verification. It replaced the `/Applications` bundle and was not launched afterward. Earlier checksums remain historical; nothing is published and the Gatekeeper path remains pending |
...
The installed-layout/apply non-live gate passes 370 default cases (134 XCTest with five skips plus 236 Swift Testing with two disabled opt-in cases), Swift/Xcode Debug and Release, Analyze, and universal mounted-package verification. Current local DMG SHA-256 is `e2927513543903b794bea08628064b29c12604e18706bef169c20b3e89760bcd`; it replaced the `/Applications` bundle and was not launched afterward.
