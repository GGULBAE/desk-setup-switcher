...
This report records the final-source synthetic render and read-only accessibility inspection for Desk Setup Switcher. It separates what the evidence proves from interactions and hardware behavior that remain pending.
...
Logical sizes below are the audit configuration's content targets. PNG pixel dimensions include Retina scaling, window chrome, and shadow. The overview host sizes itself vertically to its localized content.
...
| 3 | Profile editor | English, standard | 980×720 | [PNG](evidence/manual-ui-audit-2026-07-14/03-editor-en-standard.png) | [AX](evidence/manual-ui-audit-2026-07-14/03-editor-en-standard.ax.txt) | Pass: selection, metadata, Display/Primary disclosure, fixed action bar, storage status, and import/export controls are visible. Each profile row appears once in AX with a combined name/state description. |
| 4 | Profile editor | Korean, standard | 980×720 | [PNG](evidence/manual-ui-audit-2026-07-14/04-editor-ko-standard.png) | [AX](evidence/manual-ui-audit-2026-07-14/04-editor-ko-standard.ax.txt) | Pass: Korean tabs, labels, status, action bar, and storage text fit the standard layout; profile-row AX duplication is absent. |
