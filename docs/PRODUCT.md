...
Desk Setup Switcher is a pre-release 0.1.0 implementation candidate. The current stable permission-handoff follow-up passed integrated non-live `make verify` on 2026-07-14 with 301 default cases (129 XCTest plus 172 Swift Testing cases, six opt-in skips), zero failures, lint, Swift and universal Xcode Debug/Release, Analyze, and mounted package/checksum verification. Its five opt-in read-only display, audio, network, input, and combined readiness-context tests passed on the immediately preceding capture source, including a sleeping online display with no active Core Graphics display. The current DMG SHA-256 is `150d1e0bb620fba52c2ec2a6a78345b5b74f44ca10c9d5375178f6ab16ea370d`; it is universal and ad-hoc signed without Developer ID, and its executable is byte-for-byte identical to the installed app running from `/Applications`. The apply-reliability package described in [APPLY-RELIABILITY-UX-GOAL.md](APPLY-RELIABILITY-UX-GOAL.md), SHA-256 `417ffbb20b6a77b9037f42d5acb998574460374675e746715474e17f9f772615`, UI-hardening commit `5f0cabc`, and its matching [GitHub Actions run](https://github.com/GGULBAE/desk-setup-switcher/actions/runs/29181900967) remain historical baselines. No new push or CI run was performed. This is not a public release or mutation proof: no live setting mutation, physical Intel run, live Keychain write, full VoiceOver/TCC audit, or quarantined Gatekeeper test exists. See [COMPLETION-CRITERIA.md](COMPLETION-CRITERIA.md) and [SUPPORT-MATRIX.md](SUPPORT-MATRIX.md).
...
The 2026-07-14 synthetic audit records six English and six Korean PNGs plus twelve read-only AX logs covering overview, editor, 680×480 minimum, simulated large text, validation, System, and diagnostics. Those captures predate the inline-delete and actionable capture-permission follow-ups. A separate user-authorized installed interaction verified the actual Settings gear open/close/reopen and the Capture privacy explanation's stable handoff to the app System window; it did not change TCC or prove the full denied/granted matrix. No full VoiceOver/keyboard/focus/contrast/real-text-size audit has run. Structural localization and deterministic accessibility metadata checks do not prove rendered layout, translation quality, or assistive-technology behavior; this section remains the acceptance target, not a completed claim.
...
The current local DMG SHA-256 is `150d1e0bb620fba52c2ec2a6a78345b5b74f44ca10c9d5375178f6ab16ea370d`; its mounted universal `x86_64 arm64` app and ad-hoc/no-Developer-ID status passed verification, and the installed `/Applications` executable matched it byte-for-byte and launched. The installed-interaction package checksum `df674b37e2a2fe9a94d37435313265069e27f6130ae05ad02b8ae822ac00e8b6`, pre-stable-handoff capture checksum `ed52b253159e6abc8fe35e606aed56cc269693a53b76986dae20a04ffb2bd4fc`, pre-live-test-adjustment capture checksum `8760d68754f3bc1eebca37319bd0d2bfc29b6b3d90832532e0a64cd072506a9b`, preceding tray/editor checksum `f3d24ae95709d0db9de13ba6032eb63a1d19a5be89af15aa68244da9019afbde`, apply-reliability checksum `417ffbb20b6a77b9037f42d5acb998574460374675e746715474e17f9f772615`, and post-fix checksum `246af7c21ac9f1ffd4c6f7523f857737f148e4354a948b0e4d9a2123bb5d827f` remain historical. Downloaded CI artifact ID `8256718472` verified the earlier UI-hardening CI DMG SHA-256 `f3d82b033e8e375c9063a9b72cbd174d94a03f0cdd4414961895db3b3dcfc3f4`. The DMGs are not byte-for-byte reproducible. Download quarantine/Gatekeeper, a tagged release, publication, and physical Intel remain unverified. The ad-hoc signature supplies integrity, not publisher identity or notarization.
