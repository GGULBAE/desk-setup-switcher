...
Desk Setup Switcher is a pre-release 0.1.0 implementation candidate. The current measured-height tray/responsive-settings follow-up passed integrated non-live `make verify` on 2026-07-15 with 305 default cases (129 XCTest plus 176 Swift Testing cases, six opt-in skips), zero failures, lint, Swift and universal Xcode Debug/Release, Analyze, and mounted package/checksum verification. Its five opt-in read-only display, audio, network, input, and combined readiness-context tests passed on the preceding capture source, including a sleeping online display with no active Core Graphics display. The current DMG SHA-256 is `8bf4d547fae0df3cbe999db84e7be169b33d495b3993cf7c37f46ba37d6ea71d`; it is universal and ad-hoc signed without Developer ID, and its executable is byte-for-byte identical to the installed app running from `/Applications`. The apply-reliability package described in [APPLY-RELIABILITY-UX-GOAL.md](APPLY-RELIABILITY-UX-GOAL.md), SHA-256 `417ffbb20b6a77b9037f42d5acb998574460374675e746715474e17f9f772615`, UI-hardening commit `5f0cabc`, and its matching [GitHub Actions run](https://github.com/GGULBAE/desk-setup-switcher/actions/runs/29181900967) remain historical baselines. This is not a public release or mutation proof: no live setting mutation, physical Intel run, live Keychain write, full VoiceOver/TCC audit, or quarantined Gatekeeper test exists. See [COMPLETION-CRITERIA.md](COMPLETION-CRITERIA.md) and [SUPPORT-MATRIX.md](SUPPORT-MATRIX.md).
...
The current local DMG SHA-256 is `8bf4d547fae0df3cbe999db84e7be169b33d495b3993cf7c37f46ba37d6ea71d`; its mounted universal `x86_64 arm64` app and ad-hoc/no-Developer-ID status passed verification, and the installed `/Applications` executable matched it byte-for-byte. Earlier local and installed-interaction checksums remain historical in the completion ledger. Historical UI-hardening artifact ID `8256718472` verified CI DMG SHA-256 `f3d82b033e8e375c9063a9b72cbd174d94a03f0cdd4414961895db3b3dcfc3f4`. The DMGs are not byte-for-byte reproducible. Download quarantine/Gatekeeper, a tagged release, publication, and physical Intel remain unverified. The ad-hoc signature supplies integrity, not publisher identity or notarization.
