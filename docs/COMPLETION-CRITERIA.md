...
| Current capture-permission full local gate | `make verify` passed on 2026-07-14: lint/localization policy; 300 default cases (129 XCTest plus 171 Swift Testing cases, six opt-in skips), zero failures; Swift Debug/Release; universal Xcode Debug/Release; Analyze; DMG/checksum; mounted resources/architectures; and ad-hoc signature classification |
...
- [x] The final-source capture-permission tree passed 300-case `make verify`, replacement package/checksum verification, and the separate opt-in five-case live-read smoke run on 2026-07-14 without mutation.
...
- [x] Menu capture returns a value-free complete/permission-needed/failure presentation, rejects captures with no applicable leaf, and never exposes an SSID. An explicit Capture action explains and requests undetermined Location permission; denied/restricted states offer macOS System Settings or an explicit Wi-Fi-free capture.
...
- [x] The capture-permission follow-up produced and verified the current replacement universal package/checksum: SHA-256 `8760d68754f3bc1eebca37319bd0d2bfc29b6b3d90832532e0a64cd072506a9b`.
