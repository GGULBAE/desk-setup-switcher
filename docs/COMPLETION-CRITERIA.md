...
| Current canonical apply-plan full local gate | `make verify` passed on 2026-07-16: 371 default cases (134 XCTest with five skips + 237 Swift Testing with two disabled opt-in cases), zero failures; lint/localization policy; Swift Debug/Release; universal Xcode Debug/Release; Analyze; DMG/checksum; mounted resources/architectures; and ad-hoc signature classification |
...
| Current follow-up package | Universal no-Developer-ID DMG SHA-256 `62a2999a6d235f163753e7cccccf34b3b64605405635ca562a621c2e4bb48662`; checksum, mount, metadata/resources, architectures, and signature classification passed |
...
- [x] The canonical apply-plan follow-up `make verify` passes 371 cases (134 XCTest with five skips + 237 Swift Testing with two disabled opt-in cases), all build/Analyze/package stages, and mounted universal-DMG verification. SHA-256 `62a2999a6d235f163753e7cccccf34b3b64605405635ca562a621c2e4bb48662` is synchronized here.
