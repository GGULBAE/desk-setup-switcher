...
| Current installed-layout/apply full local gate | `make verify` passed on 2026-07-16: 370 default cases (134 XCTest with five skips + 236 Swift Testing with two disabled opt-in cases), zero failures; lint/localization policy; Swift Debug/Release; universal Xcode Debug/Release; Analyze; DMG/checksum; mounted resources/architectures; and ad-hoc signature classification |
...
| Current follow-up package | Universal no-Developer-ID DMG SHA-256 `e2927513543903b794bea08628064b29c12604e18706bef169c20b3e89760bcd`; checksum, mount, metadata/resources, architectures, and signature classification passed |
...
- [x] The installed-layout/apply follow-up `make verify` passes 370 cases (134 XCTest with five skips + 236 Swift Testing with two disabled opt-in cases), all build/Analyze/package stages, and mounted universal-DMG verification. SHA-256 `e2927513543903b794bea08628064b29c12604e18706bef169c20b3e89760bcd` is synchronized here.
