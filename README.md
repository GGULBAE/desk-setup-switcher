...
| --- | --- |
| Current UI-stability audit | [Tray, Settings, and workflow UI stability audit](docs/UI-STABILITY-AUDIT-2026-07-16.md) records the three installed references, root-cause analysis, before/after tray and full Settings-root renders, default and minimum-large-text apply previews, accessibility review, deterministic regressions, and remaining installed/manual limits |
| Current UI-stability full local gate | `make verify` passed on 2026-07-16 with localization/policy lint, 375 default cases (134 XCTest, including five skips, + 241 Swift Testing, including two disabled opt-in cases), Swift Debug/Release, universal Xcode Debug/Release, Analyze, DMG/checksum, mounted metadata/resources/architectures, and ad-hoc signature classification. New coverage freezes the status-item anchor while open, keeps Settings anatomy/catalogs stable, suppresses duplicate editor publication, and resets tray/profile/apply-preview scroll by presentation identity |
...
| Current end-to-end local package | `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg` verified `x86_64 arm64`, English/Korean resources, `/Applications` link, mounted layout, and ad-hoc/no-Developer-ID status. SHA-256: `516b968718aeb3c1c247e1a2deca7a28d45820d119f31ea992d4b475071f3638`. It was reinstalled to `/Applications`; bundle identity, version, architectures, signature, and mounted-source executable equality passed read-only checks. It was not launched after replacement |
