...
| Current synthetic UI evidence | [Manual UI audit](docs/MANUAL-UI-AUDIT-2026-07-14.md) records 12 current-source English/Korean PNGs plus 12 nonempty, read-only AX logs. Static standard, 680×480 minimum, simulated large-text, validation, permission, and diagnostics states passed visual/AX/privacy review. Same-window resize state/focus, the actual MenuBarExtra Settings click/reopen path, keyboard-only traversal, and VoiceOver behavior remain pending |
| Current local universal package | `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg` verified `x86_64 arm64`, English/Korean resources, `/Applications` link, mounted layout, and ad-hoc/no-Developer-ID signature status. SHA-256: `fa42df665ca453165dd041fe5112a8f1a6d2314bd31512ef9371b12289132122` |
