...
The authoritative scope is [docs/PRODUCT.md](docs/PRODUCT.md). Architecture and safety boundaries are in [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) and [docs/TECHNICAL-SPEC.md](docs/TECHNICAL-SPEC.md). The current UI audit is the [P2 UI refinement audit](docs/P2-UI-REFINEMENT-AUDIT-2026-07-17.md); the [UI/UX simplification and installed-app audit](docs/UI-UX-SIMPLIFICATION-INSTALLED-AUDIT-2026-07-17.md), [native UI structural reliability audit](docs/UI-STRUCTURAL-RELIABILITY-AUDIT-2026-07-17.md), and [load/save/apply audit](docs/SETTINGS-LIFECYCLE-REFACTOR-2026-07-16.md) are preceding evidence.
...
| Current P2 full local gate | Final integrated result: 461 checks (144 XCTest + 316 Swift Testing across 39 suites + one isolated native popover regression). Do not infer this result from the preceding 446-check gate |
...
| Remaining manual checks | Popover arrow/material/ghost-frame and outside-click/deactivation behavior, complete full-app keyboard order, full-app VoiceOver/rotor and focused-control AX state, real contrast/text-size/transparency settings, TCC denial/grant, Gatekeeper/quarantine, physical Intel, login approval/retry/reboot, import/export interaction, and mutation/rollback procedures remain pending and nonblocking for P2. The P2 pass records only the bounded disclosure Return/Space and AX result above; no VoiceOver claim is made |
