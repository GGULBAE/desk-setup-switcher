...
- The menu gives each profile one primary Apply action, moves review and available-items application into a secondary menu, explains disabled actions with text and symbols, bounds long profile lists, and shows readiness refresh progress.
...
- The current UI-hardening tree passes full local `make verify` with 214 default non-live tests: 111 XCTest with five opt-in skips and 103 Swift Testing cases with one opt-in skip. The 55 new presentation-specific cases comprise 28 profile-draft XCTest cases and 27 presentation/condition Swift Testing cases.
- Universal Debug/Release, Analyze, DMG/checksum, mounted-image resource/architecture, and ad-hoc signature verification pass; the current local DMG SHA-256 is `6413e352b3d170b82510b7125f3f8cd0f52b9e5140bfa0977801887d09340e68`. UI-hardening commit `5f0cabc` and [Actions run `29181900967`](https://github.com/GGULBAE/desk-setup-switcher/actions/runs/29181900967) passed full verification and uploaded artifact ID `8256718472`; its downloaded checksum verified CI DMG SHA-256 `f3d82b033e8e375c9063a9b72cbd174d94a03f0cdd4414961895db3b3dcfc3f4`. No current-tree screenshot walkthrough, full keyboard/VoiceOver audit, TCC matrix, hardware mutation, or live Keychain test has been run.
