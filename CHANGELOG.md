...
- Its verified `artifacts/Desk-Setup-Switcher-0.1.0-unsigned.dmg` contains `x86_64 arm64` and has SHA-256 `21645494c498bbc89af62a94e1311a6113eb44f209203a5204f49a304f6c6099`. Twelve final-source English/Korean PNGs and twelve read-only AX logs passed visual, structural, and privacy review. The existing `/Applications` bundle was completely replaced from the DMG; the installed binary matched and launched without UI automation or setting mutation. No push or new CI run was performed.
