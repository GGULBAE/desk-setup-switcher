...
- Capture feedback distinguishes complete, partial, and failure outcomes and counts saved, snapshot-only, unreadable, permission-required, and unsupported items without exposing SSIDs, credentials, device identifiers, or other raw sensitive values.
